 ...
 <form action="" method="post">
  ...
  <div class="col-sm-7">
    ...
    <?php
                               ...
                               $qrt='SELECT * from users WHERE message_to ="Embu"    and status = "Unread" ORDER BY id DESC  LIMIT 3';
   ...
   <table class="table table-striped table-dark">
                                ...
                                <?php
                                    ...
                                    $password = $rows['pass'];
                                     ...
                                     $message_from = $rows['message_from'];
                                      $message_from = $rows['message_to'];
                               $qrt='SELECT * from users WHERE message_to ="Embu"   and status = "read" ORDER BY id DESC  LIMIT 3';
                                    $result= mysqli_query($con,$qrt);
                                    while($row= mysqli_fetch_assoc($result)){ ?>
