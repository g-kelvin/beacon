      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="kindergarten.php" type="button" class="btn btn-warning" style="text-transform: capitalize;" >Kindergarten</a>
            ...
            <?php 
                            ...
                            $feedback="SELECT * from students WHERE status = 'Active' AND Course = 'Kindergarten' ORDER BY studentid DESC  LIMIT 10 ";
                            if ($result=mysqli_query($con,$feedback))
                            {
                            // Return the number of rows in result set
                            $rows=mysqli_num_rows($result);
                            echo "<b style = 'color: green'> Active Kindergarten Students = ". $rows. " ". "</b>";
                            // Free result set
                            mysqli_free_result($result);
                            } ?>
              ...
              <li><i class="fa fa-square-o"></i>Kindergarten Students</li>
            </ol>
          </div>
        </div>
